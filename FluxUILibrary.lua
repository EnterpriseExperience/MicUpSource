...
function Flux:Window(text, bottom,mainclr,toclose)
    ...
    function Flux:Notification(desc, buttontitle, duration)
        ...
        NotificationTitle.Position = UDim2.new(0.04, 0, 0.076, 0)
        ...
        CloseBtn.Position = UDim2.new(0.04, 0, 0.721, 0)
        ...
        NotificationDesc.Position = UDim2.new(0.1125, 0, 0.266, 0)
        ...
        local function CloseNotification()
            TweenService:Create(NotificationDesc, TweenInfo.new(.3, Enum.EasingStyle.Quad), {TextTransparency = 1}):Play()
            TweenService:Create(NotificationTitle, TweenInfo.new(.3, Enum.EasingStyle.Quad), {TextTransparency = 1}):Play()
            TweenService:Create(CloseBtn, TweenInfo.new(.3, Enum.EasingStyle.Quad), {TextTransparency = 1, BackgroundTransparency = 1}):Play()
            ...
            task.wait(.2)
            TweenService:Create(NotificationBase, TweenInfo.new(.3, Enum.EasingStyle.Quad), {BackgroundTransparency = 1}):Play()
        ...
        CloseBtn.MouseEnter:Connect(function()
            TweenService:Create(CloseBtn, TweenInfo.new(.3, Enum.EasingStyle.Quad), {TextTransparency = 0}):Play()
        end)

        CloseBtn.MouseLeave:Connect(function()
            TweenService:Create(CloseBtn, TweenInfo.new(.3, Enum.EasingStyle.Quad), {TextTransparency = 0.3}):Play()
        end)

        CloseBtn.MouseButton1Click:Connect(CloseNotification)

        TweenService:Create(NotificationBase, TweenInfo.new(.3, Enum.EasingStyle.Quad), {BackgroundTransparency = 0.55}):Play()
        ...
        task.wait(.4)
        TweenService:Create(NotificationDesc, TweenInfo.new(.3, Enum.EasingStyle.Quad), {TextTransparency = .3}):Play()
        TweenService:Create(CloseBtn, TweenInfo.new(.3, Enum.EasingStyle.Quad), {TextTransparency = .3, BackgroundTransparency = 0}):Play()
        TweenService:Create(NotificationTitle, TweenInfo.new(.3, Enum.EasingStyle.Quad), {TextTransparency = 0}):Play()

        if duration and typeof(duration) == "number" then
            task.spawn(function()
                task.wait(duration)
                if NotificationBase.Visible then
                    CloseNotification()
                end
            end)
        end
