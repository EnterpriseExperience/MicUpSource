...
g.Start_Actual_Flames_Hub_Script = function()
   ...
   loadstring(game:HttpGet("https://raw.githubusercontent.com/EnterpriseExperience/MicUpSource/refs/heads/main/LifeTogetherRP_Admin_CommandHandler.lua"))() -- loads commands all the commands.
