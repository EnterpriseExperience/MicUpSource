...
--]]
    ...
    Callback = function(slotName)
        ...
        getgenv().notify("Success:", "Selected Slot: "..tostring(slotName).." (KeyCode: "..tostring(selectedSlot)..")", 6)
    end,})
    ...
    Callback = function(emote)
        ...
        getgenv().notify("Success:", "Assigned emote: '"..emote.."' to keybind: "..selectedSlot.Name, 6)
    end,})
    ...
    Callback = function(Bind_Freeze)
        local keyCode = Enum.KeyCode[Bind_Freeze]

        if not keyCode then
            return warn("Invalid keybind selection:", Bind_Freeze)
        end
        wait()
        Emote_Speed_Configuration[keyCode] = 0

        getgenv().notify("Success:", "Freeze keybind updated to: " .. Bind_Freeze, 6)
    end,})
    ...
    Callback = function(Bind_Reverse)
        local keyCode = Enum.KeyCode[Bind_Reverse]
        ...
        getgenv().notify("Success:", "Reverse keybind updated to: " .. Bind_Reverse, 6)
    end,})
