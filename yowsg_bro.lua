...
--]]
    ...
    Callback = function(Bind_Freeze)
        if type(Bind_Freeze) == "string" and Enum.KeyCode[Bind_Freeze] then
            Freeze_Keybind = Enum.KeyCode[Bind_Freeze]
        end
    end,})
    ...
    Callback = function(Bind_Reverse)
        if type(Bind_Reverse) == "string" and Enum.KeyCode[Bind_Reverse] then
            Reverse_Keybind = Enum.KeyCode[Bind_Reverse]
        end
    end,})
