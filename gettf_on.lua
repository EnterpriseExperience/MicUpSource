...
--]]
    ...
    local function connect_anims()
        LocalPlayer.CharacterAdded:Connect(function(newCharacter)
            print("New Character for Animation Packages: "..tostring(newCharacter)..", waiting to load.")
            wait(3)
            if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("Humanoid") or LocalPlayer.Character:FindFirstChildOfClass("Animator") and newCharacter:FindFirstChild("Animate") then
                wait(2)
                connect_to_animations()
            else
                warn("Humanoid or Animate script not found within newCharacter!")
            end
        end)
