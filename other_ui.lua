...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			...
			Background = Color3.fromRGB(155, 0, 152),
			Topbar = Color3.fromRGB(155, 0, 152),
			Shadow = Color3.fromRGB(155, 0, 152),

			NotificationBackground = Color3.fromRGB(155, 0, 152),
			NotificationActionsBackground = Color3.fromRGB(155, 0, 152),

			TabBackground = Color3.fromRGB(155, 0, 152),
			TabStroke = Color3.fromRGB(155, 0, 152),
			TabBackgroundSelected = Color3.fromRGB(155, 0, 152),
			TabTextColor = Color3.fromRGB(0, 0, 0),
			SelectedTabTextColor = Color3.fromRGB(155, 0, 152),

			ElementBackground = Color3.fromRGB(155, 0, 152),
			ElementBackgroundHover = Color3.fromRGB(155, 0, 152),
			SecondaryElementBackground = Color3.fromRGB(155, 0, 152),
			ElementStroke = Color3.fromRGB(155, 0, 152),
			SecondaryElementStroke = Color3.fromRGB(155, 0, 152),

			SliderBackground = Color3.fromRGB(155, 0, 152),
			SliderProgress = Color3.fromRGB(155, 0, 152),
			SliderStroke = Color3.fromRGB(155, 0, 152),
			...
			DropdownSelected = Color3.fromRGB(7, 0, 123),
			DropdownUnselected = Color3.fromRGB(30, 30, 30),

			InputBackground = Color3.fromRGB(30, 30, 30),
			InputStroke = Color3.fromRGB(65, 65, 65),
			PlaceholderColor = Color3.fromRGB(155, 0, 152)
		},
