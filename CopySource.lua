...
Callback = function()
    ...
    local function unclaimStalls()
        for _, stall in pairs(Folder:GetChildren()) do
            if stall:FindFirstChild("ProxPart") and stall:FindFirstChild("Player") then
                ...
                if owner ~= whitelist[Players[owner].UserId] then
    ...
    local function cancelAllButtons()
        local Signals = {"Activated", "MouseButton1Down", "MouseButton2Down", "MouseButton1Click", "MouseButton2Click"}
        local StallFrame = localPlayer.PlayerGui.StallLocal.StallFrame
...
Callback = function()
    ...
    wait(1)
    loadstring(game:HttpGet(('https://raw.githubusercontent.com/EnterpriseExperience/MicUpSource/main/CopySource.lua')))()
end})
