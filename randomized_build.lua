...
--]]
    ...
    if getgenv().scriptEnabled then
        ...
        if getgenv().Easies_Configuration["Emote_Keybinds"] == true then
            ...
            if not Humanoid then
                return warn("Humanoid not found after waiting!")
            end
            ...
            wait(0.2)
            repeat wait(2) until character and Humanoid and character:FindFirstChild("Humanoid") and character:FindFirstChild("HumanoidRootPart")
            wait()
            if character and Humanoid then
                print("Found Humanoid!")
            else
                return warn("No Humanoid found!")
            end
            wait()
            ...
            local function playEmote(emoteId)
                if not humanoid then
                    ...
                    repeat wait(2) until character and humanoid
                    wait(1)
                    if character and humanoid then
