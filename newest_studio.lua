        ...
        if antiVoidFall then
            ...
            local function updateBaseplate()
                ...
                while getgenv().anti_void_player == true do
                    ...
                    if rootPart then
                        local newPos = Vector3.new(rootPart.Position.X, rootPart.Position.Y - rootPart.Size.Y / 2 - baseplate.Size.Y / 2, rootPart.Position.Z)
            ...
            getgenv().anti_void_player = false
            wait(0.3)
            if game:GetService("Workspace"):FindFirstChild("ANTI_VOID_BASEPLATE") then
