...
local reveal_text_phrases = {
    "Make sure to use our 'feedback' command to report users, request features, report bugs/issues, and more!",
    "Make sure to recommend us to everyone you know!",
    "Remember!: Do NOT harass, bully, or otherwise target other Flames Hub users! you can get BANNED from Flames Hub for doing it!",
    "Ensuring Flames Hub always provides top notch services and utilities is our speciality!",
    "Nobody can replicate / clone Flames Hub for a reason! We're too good at what we do!",
    "Flames Hub has almost daily updates, over 195+ commands, customizable features, easy configuration and more!",
    "We dominate the market for a reason! Flames Hub forever!",
    "Don't forget that Flames Hub will always be #1!",
    "Did you know? Flames Hub automatically runs an anti-cheat scan incase Life Together RP adds an anti-cheat?",
    "We provide you with protection, endurance, power and much more, in return you help promote our services and utilities!",
    "If you enjoy Flames Hub, don't forget to send us YOUR feedback if you haven't already! using our 'feedback' command.",
    "©️ | Flames Hub | ON TOP | 15K+ users daily! | amazing community! | ©️"
}
...
ui_gradient.Color = ColorSequence.new{
    ...
    ColorSequenceKeypoint.new(1, Color3.fromRGB(180, 60, 140))
}
