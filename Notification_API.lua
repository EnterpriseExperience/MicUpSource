...
local Sound_ID_Windows = 8183296024
local Sound_ID_iPhone = 73722479618078
local Sound_ID_Android = 17582299860
local Sound_ID_Universal = 18595195017
...
function External_Notification(Type, Content, Time)
    if not Time then
        Time = 5
    end
    wait()
