...
--]]
    ...
    Callback = function()
        ...
        local function saveConfig()
            local config = {
                Emote_Keybinds_Configuration = Emote_Keybinds_Configuration,
                Emote_Speed_Configuration = Emote_Speed_Configuration
            }
    ...
    Callback = function()
        local function loadConfig()
            if isfile(ConfigFileName) then
                ...
                Emote_Keybinds_Configuration = config.Emote_Keybinds_Configuration
                Emote_Speed_Configuration = config.Emote_Speed_Configuration
