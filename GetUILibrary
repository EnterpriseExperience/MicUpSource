...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			...
			Topbar = Color3.fromRGB(144, 0, 0),
			Shadow = Color3.fromRGB(144, 0, 0),

			NotificationBackground = Color3.fromRGB(0, 0, 0),
			NotificationActionsBackground = Color3.fromRGB(0, 0, 0),

			TabBackground = Color3.fromRGB(0, 0, 0),
			TabStroke = Color3.fromRGB(29, 29, 29),
			TabBackgroundSelected = Color3.fromRGB(29, 29, 29),
...
Main.BackgroundColor3 = Color3.fromRGB(14, 0, 169)
