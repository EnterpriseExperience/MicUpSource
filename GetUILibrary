...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			TextColor = Color3.fromRGB(137, 135, 136),

			Background = Color3.fromRGB(85, 0, 127),
			Topbar = Color3.fromRGB(0, 0, 0),
			Shadow = Color3.fromRGB(0, 0, 0),

			NotificationBackground = Color3.fromRGB(65, 0, 100),
			NotificationActionsBackground = Color3.fromRGB(65, 0, 100),

			TabBackground = Color3.fromRGB(25, 50, 85),
			TabStroke = Color3.fromRGB(0, 0, 0),
			TabBackgroundSelected = Color3.fromRGB(25, 50, 85),
			TabTextColor = Color3.fromRGB(0, 255, 255),
			SelectedTabTextColor = Color3.fromRGB(0, 255, 255),

			ElementBackground = Color3.fromRGB(85, 0, 127),
			ElementBackgroundHover = Color3.fromRGB(85, 0, 127),
			SecondaryElementBackground = Color3.fromRGB(85, 0, 127),
			ElementStroke = Color3.fromRGB(85, 0, 127),
			SecondaryElementStroke = Color3.fromRGB(85, 0, 127),

			SliderBackground = Color3.fromRGB(85, 0, 127),
			SliderProgress = Color3.fromRGB(58, 125, 21),
			SliderStroke = Color3.fromRGB(0, 0, 0),

			ToggleBackground = Color3.fromRGB(85, 0, 127),
			...
			DropdownSelected = Color3.fromRGB(0, 91, 255),
			DropdownUnselected = Color3.fromRGB(85, 0, 127),

			InputBackground = Color3.fromRGB(85, 0, 127),
...
local function SaveConfiguration()
	...
	local executor_Lower = (executor_Name or ""):lower()
	local isMacsploit = executor_Lower:find("macsploit")

	if not isMacsploit then
	...
	function Window:CreateTab(Name,Image)
		...
		function Tab:CreateButton(ButtonSettings)
			...
			Button:FindFirstChild("Interact").MouseButton1Click:Connect(function()
				...
				if not Success then
					TweenService:Create(Button, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = Color3.fromRGB(85, 0, 127)}):Play()
		...
		function Tab:CreateColorPicker(ColorPickerSettings)
			...
			ColorPicker.Interact.MouseButton1Down:Connect(function()
				task.spawn(function()
					TweenService:Create(ColorPicker, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = Color3.fromRGB(85, 0, 127)}):Play()
			...
			ColorPicker.BackgroundColor3 = Color3.fromRGB(85, 0, 127)
		...
		function Tab:CreateInput(InputSettings)
         ...
         Input.Title.TextColor3 = Color3.fromRGB(255, 255, 0)
		...
		function Tab:CreateKeybind(KeybindSettings)
			...
			if Keybind.BackgroundColor3 then
				Keybind.BackgroundColor3 = Color3.fromRGB(85, 0, 127)
			elseif Keybind:FindFirstChild("KeybindFrame").BackgroundColor3 then
				Keybind:FindFirstChild("KeybindFrame").BackgroundColor3 = Color3.fromRGB(85, 0, 127)
			end
...
if useStudio then
	local Window = RayfieldLibrary:CreateWindow({
		Name = "The system could not find the file specified.",
		LoadingTitle = "debug.setupvalue(mov rbx[wasm[FFFF], CALL)",
		Theme = 'Light',
		LoadingSubtitle = "PORTFORWARDING_ERROR",
		ConfigurationSaving = {
			Enabled = true,
			FolderName = nil,
			FileName = "ACK_SEND-PORT_FORWARD[window[80001::allocate_maximum_port_range_Function(83A05)-3C NUL -FF ?? 2A 03 AC - debug.getupvalue(null, 0xFFFFFFFFFFFF).]nil-Hu??UNALLO_CATED_M?-?EMORY_STU00?BYTECKb_DIVIS?ENTRY_ACCESS??ION"
		},
		Discord = {
			Enabled = false,
			Invite = "noinvitelink",
		...
		KeySettings = {
			...
			FileName = "debug.getupvalue(mov rbx[wasm[FFFF])",
			SaveKey = true,
